...
%>
        ...
        <a class="layui-btn layui-btn-xs" lay-event="yes">批准</a>
        ...
        if(layEvent === 'no'){
        layer.confirm('是否不通过此次会议', function(index){
        layer.open({
        type:1,//类型
        title:'填写拒绝理由',
        area:['20%','20%'],//定义宽和高
        ...
        /*$.ajax({
        url:"CheckMeetController/NotCheckMeet",
        type:"post",
        data:{
        ...
        $.ajax({
        url:"CheckMeetController/CheckMeet",
        type:"post",
        data:{
        "orderId":data.order_id
        },
