...
%>
        ...
        url: 'ApplyMeetController/QueryRefuseMeet',
        limits:[1,3,7,10,50,100],
        limit: 10, //默认为10
        //加载表格内容
        cols: [[//标题栏
        {type: 'checkbox', fixed: 'left'},
        {field: 'order_id', width: 120, title: 'id'}, //sort：true页面可进行排序操作
        ...
        "<tr><td>"+"查看范围："+"</td><td>"+data[0].ids+"</td></tr>"+
        "<tr><td>"+"拒绝理由："+"</td><td>"+data[0].order_reason+"</td></tr>"
        );
        }
        });
        layer.open({
